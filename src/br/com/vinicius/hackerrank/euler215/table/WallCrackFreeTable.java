...
class Wall extends Brick {
	...
	private Map<Long, Integer> idxMap = new HashMap<>(1000);
	...
	public long countWalls() {
		...
		// System.out.println("Bit Lines=" + bitLines.size() + " seconds: " +
		// (new Date().getTime() - ini.getTime()) / 1000);

		// ini = new Date();
		generateAdjacentLines();
		// System.out.println("Adjacent Lines=" + adjacentLines.totChildren +
		// " seconds: " + (new Date().getTime() - ini.getTime()) / 1000);
